...
public class Ternary {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		for(int i=0;i<name.size();i++) {
			b1=(age.get(i)<10.0 && survived.get(i)==1)? s_children.add(name.get(i)) : false;
			
			b1=(age.get(i)<10.0 && survived.get(i)==0)? ns_children.add(name.get(i)) : false; 
			
			b1=(age.get(i)>10.0 && survived.get(i)==1 && sex.get(i).equals("male"))? s_men.add(name.get(i)) : false;
			
			b1=(age.get(i)>10.0 && survived.get(i)==0 && sex.get(i).equals("male"))? ns_men.add(name.get(i)) : false;

			b1=(age.get(i)>10.0 && survived.get(i)==1 && sex.get(i).equals("female"))? s_women.add(name.get(i)) : false;
			
			b1=(age.get(i)>10.0 && survived.get(i)==0 && sex.get(i).equals("female"))? ns_women.add(name.get(i)) : false;
		}
